...
{
    std::ofstream fout(ament_index_cpp::get_package_share_directory("planner") + "/data/boost_voronoi_edges.csv");
...
int main()
{
    ...
    std::string wkt_string = get_polygon_from_file(ament_index_cpp::get_package_share_directory("planner") + "/data/polygon.txt");
